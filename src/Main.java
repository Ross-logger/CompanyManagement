    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try {
            ...
            while (inFile.hasNext()) {
                ...
                } catch (ExInsufficientCommandArgs | ExTeamAlreadyExists | NumberFormatException | ExEmployeeNotFound |
                         ExProjectAlreadyExists | ExProjectNotFound | ExTeamNotFound | ExEmployeeAlreadyExists |
                         ExProjectIsAlreadyAssigned | ExEmployeeHasAlreadyJoinedTeam | ExInsufficientAnnualLeaves |
                         ExProjectIsOnFinalStage | ExLeaveOverlapped e) {
